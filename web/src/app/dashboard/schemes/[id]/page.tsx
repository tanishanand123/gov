    ...
    <div>
      <div className="scheme-hero">
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
          <Link href="/dashboard/schemes" className="btn btn-outline btn-sm">← Back to Schemes</Link>
        ...
        <div style={{ display: "flex", alignItems: "flex-start", gap: 20, flexWrap: "wrap" }}>
          <div style={{ flex: 1, minWidth: 280 }}>
            ...
            <span className="category-chip cat-scholarship" style={{ marginBottom: 12, display: "inline-flex" }}>🎓 Scholarship</span>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginTop: 8 }}>
              <span className="badge badge-eligible" style={{ fontSize: 13, padding: "6px 14px" }}>ELIGIBLE ✓</span>
              <span style={{ fontSize: 12, background: "#FEE2E2", color: "#DC2626", padding: "4px 10px", borderRadius: 8 }}>⏰ Apply by: Dec 31, 2026</span>
            </div>
            <div style={{ marginTop: 12, fontSize: 13, color: "var(--text-muted)" }}>
              <a href="#" className="link">🔗 scholarship.gov.in →</a>
            </div>
          </div>
      ...
      <div className="sticky-bottom">
        ...
        <div style={{ display: "flex", gap: 10 }}>
          ...
          <Link href="/dashboard/apply/pm-scholarship-capf" className="btn btn-primary">Apply via SmartGov ⚡</Link>
        </div>
      </div>
    </div>
  );
