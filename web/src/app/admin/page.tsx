...
import { Users, CheckCircle2, FileText, Clock, UserPlus, Megaphone } from "lucide-react";
    ...
    <div>
      ...
      <div className="stats-grid" style={{ marginBottom: 24 }}>
        <div className="admin-stat-card">
          <div className="stat-icon" style={{ background: "linear-gradient(135deg,#6366F1,#4338CA)" }}><Users size={18} strokeWidth={2} color="#fff" /></div>
        ...
        <div className="admin-stat-card">
          <div className="stat-icon" style={{ background: "linear-gradient(135deg,#F59E0B,#D97706)" }}><Clock size={18} strokeWidth={2} color="#fff" /></div>
        ...
        <div className="admin-stat-card">
          <div className="stat-icon" style={{ background: "linear-gradient(135deg,#EC4899,#DB2777)" }}><UserPlus size={18} strokeWidth={2} color="#fff" /></div>
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
          ...
          <Link href="/admin/settings" className="btn btn-outline" style={{ borderColor: "#334155", color: "#94A3B8" }}><Megaphone size={14} strokeWidth={2} /> Send Bulk Notification</Link>
        </div>
      </div>
      ...
      <div style={{ background: "#1E293B", borderRadius: 16, border: "1px solid #334155", padding: 20 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12, padding: 10, borderRadius: 10, background: "rgba(99,102,241,0.06)" }}>
            <span style={{ display: "flex", color: "#818CF8" }}><FileText size={18} strokeWidth={2} /></span>
            <div style={{ flex: 1 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12, padding: 10, borderRadius: 10 }}>
            <span style={{ display: "flex", color: "#10B981" }}><CheckCircle2 size={18} strokeWidth={2} /></span>
            <div style={{ flex: 1 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12, padding: 10, borderRadius: 10 }}>
            <span style={{ display: "flex", color: "#EC4899" }}><Megaphone size={18} strokeWidth={2} /></span>
            <div style={{ flex: 1 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12, padding: 10, borderRadius: 10 }}>
            <span style={{ display: "flex", color: "#94A3B8" }}><UserPlus size={18} strokeWidth={2} /></span>
            <div style={{ flex: 1 }}>
